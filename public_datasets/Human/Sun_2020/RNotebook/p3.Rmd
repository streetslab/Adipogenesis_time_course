...
Patient Number: sample 3
```{r}
library(DropletUtils)
library(Seurat)
p1=Read10X_h5(filename = "/home/rstudio/time-series/wolfrum/umi-counts/sample_3/output_filtered_hw3.h5")
...
```{r}
write.table(x = colnames(s.object),file = "/home/rstudio/time-series/wolfrum/barcodes/sample.3.txt",sep = "\n",row.names = FALSE,col.names = FALSE,quote = FALSE,eol = "\n")
```
