...
Patient Number: sample 2
```{r}
library(DropletUtils)
library(Seurat)
p1=Read10X_h5(filename = "/home/rstudio/time-series/wolfrum/umi-counts/sample_2/output_filtered_hw2.h5")
...
```{r}
write.table(x = colnames(s.object),file = "/home/rstudio/time-series/wolfrum/barcodes/sample.2.txt",sep = "\n",row.names = FALSE,col.names = FALSE,quote = FALSE,eol = "\n")
```
